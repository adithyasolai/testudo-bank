...
public class MvcController {
  ...
  // Helper method that calculates overdraft interest fee
  private int applyInterestRateToPennyAmount(int excessWithdrawAmtInPennies) {
    int result = (int)(excessWithdrawAmtInPennies * INTEREST_RATE);
    return result;
  }
