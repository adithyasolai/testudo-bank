...
*/
@Test
public void testInterestWithDeposit() throws SQLException, ScriptException {
    // initialize customer1 with a balance of 0
    double CUSTOMER1_BALANCE = 0;
    int CUSTOMER1_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers.convertDollarsToPennies(CUSTOMER1_BALANCE);
    MvcControllerIntegTestHelpers.addCustomerToDB(dbDelegate, CUSTOMER1_ID, CUSTOMER1_PASSWORD, CUSTOMER1_FIRST_NAME, CUSTOMER1_LAST_NAME, CUSTOMER1_BALANCE_IN_PENNIES, 0);

    // Prepare Deposit Form for 20 dollars
    ...
    // send request to the Deposit Form's POST handler in MvcController 5 times
    controller.submitDeposit(customer1DepositFormInputs);
    controller.submitDeposit(customer1DepositFormInputs);
    controller.submitDeposit(customer1DepositFormInputs);
    controller.submitDeposit(customer1DepositFormInputs);
  ...
  /**
* Verifies deposit case where a customer receives does not recieve interest after 5 insufficient deposits
* of 20 dollars or more while not being in overdraft.
*
...
*/
@Test
public void testNoInterestWithDeposit() throws SQLException, ScriptException {
    // initialize customer1 with a balance of $0
    double CUSTOMER1_BALANCE = 0;
    int CUSTOMER1_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers.convertDollarsToPennies(CUSTOMER1_BALANCE);
    MvcControllerIntegTestHelpers.addCustomerToDB(dbDelegate, CUSTOMER1_ID, CUSTOMER1_PASSWORD, CUSTOMER1_FIRST_NAME, CUSTOMER1_LAST_NAME, CUSTOMER1_BALANCE_IN_PENNIES, 0);
    ...
    // verify customer balance was not increased by $1.50
    double CUSTOMER1_EXPECTED_FINAL_BALANCE = 101.5;
    double CUSTOMER1_EXPECTED_FINAL_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers.convertDollarsToPennies(CUSTOMER1_EXPECTED_FINAL_BALANCE);
...
*/
@Test
public void testInterestAfter5th() throws SQLException, ScriptException {
    // initialize customer1 with a balance of $0
    double CUSTOMER1_BALANCE = 0;
    int CUSTOMER1_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers.convertDollarsToPennies(CUSTOMER1_BALANCE);
    MvcControllerIntegTestHelpers.addCustomerToDB(dbDelegate, CUSTOMER1_ID, CUSTOMER1_PASSWORD, CUSTOMER1_FIRST_NAME, CUSTOMER1_LAST_NAME, CUSTOMER1_BALANCE_IN_PENNIES, 0);
